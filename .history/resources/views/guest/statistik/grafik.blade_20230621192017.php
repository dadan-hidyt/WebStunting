...
<body>
    <div class="container mt-2">
        ...
        <p class="alert alert-info mt-3">
            <div class="card-title">Silahkan pilih Kabupaten / Kota</div>
        </p>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header bg-warning text-white">
                            <div class="card-title">Total Kasus Berdasarkan Jenis Kelamin</div>
                        </div>
                        <div class="card-body">
                            <div id="byJk"></div>
                        </div>
                ...
                <div class="col-md-3">
                    <div class="card">
                        <div class="card-header bg-success text-white">
                            <div class="card-title">Total Kasus Berdasarkan Umur</div>
                        </div>
                        <div class="card-body">
                            <div id="byUmur"></div>
                        </div>
                ...
                <div class="col-md-3">
                    <div class="card" style="height: 100%">
                        <div class="card-header bg-info text-white">
                            <div class="card-title">Prevalensi</div>
                        </div>
